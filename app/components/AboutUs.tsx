    ...
    return (
        ...
        <div className={"flex justify-around py-4"}>
            <div
                ...
                <p id={"box-body"} className={"text-lg"}>At Chronocademy, we believe in making education accessible
            ...
            <div
                ...
                <p id={"box-body"} className={"text-lg"}>
                    ...
                    <li>Community: Building strong connections between learners and teachers around the globe.</li>
