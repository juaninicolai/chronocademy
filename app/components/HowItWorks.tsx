...
export default function HowItWorks() {
    return (
        <div id="how-it-works" className="flex flex-col justify-center items-center py-16">
            ...
            <div className="flex flex-wrap justify-center gap-10 pt-16">
                <Box
                    ...
                    body={
                        <>
                            Use some of your time to <span className="font-bold">teach</span> any of your 
                            skills to someone else or <span className="font-bold">refer</span> us to a 
                            friend and earn Chrono credits for it.
                        </>
                    }
                />
                <Box
                    ...
                    body={
                        <>
                            Use your Chrono credits to <span className="font-bold">learn</span> a skill 
                            from someone else or to <span className="font-bold">unlock rewards or 
                            services</span> offered by Chronocademy.
                        </>
                    }
                />
                <Box
                    ...
                    body={
                        <>
                            ...
                            can <span className="font-bold">buy or sell</span> Chrono credits in the platform.
                        </>
                    }
                />
            </div>
