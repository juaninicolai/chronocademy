      ...
      <div className={"flex flex-wrap justify-center gap-10 pt-8"}>
        ...
        >
          ...
          <p id={"box-body"} className={"text-lg"}>
            ...
            &nbsp;&nbsp;&nbsp;Our mission is to create a global community where people can freely exchange skills, knowledge, and experiences 
            through a unique time-based currency system called Chrono. <br/>&nbsp;&nbsp;&nbsp;We aim to empower individuals to learn and teach at their 
        ...
        >
          ...
          <p id={"box-body"} className={"text-lg"}>
            ...
            &nbsp;&nbsp;&nbsp;By breaking down financial barriers, we aim to help people from all backgrounds to grow, share their expertise, and collaborate across borders. <br/>
            &nbsp;&nbsp;&nbsp;Our vision is to foster a culture of lifelong learning, driven by passion and curiosity, and to create a global community connected through the 
