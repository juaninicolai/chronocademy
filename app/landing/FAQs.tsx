    ...
    <div id={"faqs"} className={"px-6 sm:px-28"}>
      ...
      <div className={"font-roboto text-h3"}>
        ...
        <details className="py-4 cursor-pointer font-medium">
          ...
          <h4 className={"pt-4 font-normal text-lg"}>
            Classes can be scheduled through our integrated calendar or through
            the platform chat when getting an agreement with the other user.
            <br />
            <br />
          </h4>
        </details>
        <details className="py-4 cursor-pointer font-medium">
          ...
          <h4 className={"pt-4 font-normal text-lg"}>
            ...
            type of skill. The price can be negotiated with the tutor only
            through the platform chat. If a class is booked directly through the
            calendar, the price will be the one set by default by the teacher.
            <br />
            <br />
          </h4>
        </details>
